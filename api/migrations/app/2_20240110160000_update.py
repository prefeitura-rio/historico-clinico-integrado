...
async def upgrade(db: BaseDBAsyncClient) -> str:
    return """
        ...
        DROP TABLE IF EXISTS "addressuse" CASCADE;
        ...
        DROP TABLE IF EXISTS "rawpatientrecord" CASCADE;
        DROP TABLE IF EXISTS "state" CASCADE;
        DROP TABLE IF EXISTS "city" CASCADE;
        DROP TABLE IF EXISTS "address" CASCADE;
        DROP TABLE IF EXISTS "patientrecord" CASCADE;
        DROP TABLE IF EXISTS "addresspatientperiod" CASCADE;
        DROP TABLE IF EXISTS "cns" CASCADE;
        DROP TABLE IF EXISTS "telecomsystem" CASCADE;
        DROP TABLE IF EXISTS "telecomuse" CASCADE;
        DROP TABLE IF EXISTS "telecom" CASCADE;
        DROP TABLE IF EXISTS "telecompatientperiod" CASCADE;
